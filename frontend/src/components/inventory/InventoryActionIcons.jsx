/** Inline SVG icons for inventory row actions (no external icon dependency). */
...
export function InventoryIconButton({ label, onClick, children, className = "" }) {
  return (
    <button
      type="button"
      className={`inventory-icon-btn ${className}`.trim()}
      title={label}
      aria-label={label}
      onClick={onClick}
    >
