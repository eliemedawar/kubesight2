/**
 * Sidebar glyphs, keyed by pageKey.
 *
 * Split out of Sidebar.jsx unchanged: 114 lines of path data made the
 * navigation behaviour hard to read, and the behaviour is the part that was
 * being reworked.
 */
